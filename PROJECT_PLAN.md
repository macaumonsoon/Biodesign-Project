...
| [`web/extinction-archive/index.html`](web/extinction-archive/index.html) | **Web prototype:** **full taxa list** (filter/search from `archive.json`), P0 WebXR scenes + **Khronos-licensed glTF** placeholders under Scene\_\*, pigeon mini-scene, ethics fork, **`postMessage`** (origin-scoped) ↔ reflection template. **Preview URLs:** [`web/extinction-archive/CURSOR_PREVIEW.md`](web/extinction-archive/CURSOR_PREVIEW.md). |
